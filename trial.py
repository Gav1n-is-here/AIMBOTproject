# python detect.py --weights models/cs088.pt --img 640 --conf 0.5 --source data/images --project runs/detect --name cs2test --save-txt --save-conf --device cpu
# python detect.py --weights models/cs088.pt --source "screen 0 640 360 640 360" --project runs/detect --name mss2test 
...
def parse_opt():
    ...
    parser.add_argument("--source", type=str, default=ROOT / "screen 0 640 360 640 360", help="file/dir/URL/glob/screen/0(webcam)")
